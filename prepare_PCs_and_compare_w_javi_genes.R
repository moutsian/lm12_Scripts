run21121=read.table("/lustre/scratch115/realdata/mdt3/projects/paxgene/IU.21121.transcript_to_gene.rpkm",sep="\t",head=T)
run21364=read.table("/lustre/scratch115/realdata/mdt3/projects/paxgene/IU.21364.transcript_to_gene.rpkm",sep="\t",head=T)
...
plot(data_reordered[,2],data_reordered[,3],col=c(rep("darkblue",16),rep("lightblue",16),rep("darkred",29),rep("red",38)),main=list("PCA, Genes RPKM",cex=1.1),pch=c(rep(c(rep(15,4),rep(16,4),rep(17,4),rep(18,4)),2),rep(19,67)))
legend(y=0.15,x=0.10,pch=19,col=c("darkblue","lightblue","darkred","red"),legend=c("Run21121","Run21364","Nasal","Blood"))
