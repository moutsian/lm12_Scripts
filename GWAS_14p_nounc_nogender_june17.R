...
gwas14_nounc_noG_june17_INT = function(interaction_term,status,H1,H2,H3,H4,H5,H6,H7,H8,H9,H10,H11,H12,H13,H14,PC){ ## where INT refers to H8 here, which is included as an interaction with DRB*15:01 (presence/absence)
  pH1=H1;
  pH2=H2;
  pH3=H3;
  pH4=H4;
...
if(dim(summary(M14)$coeff)[1]==23){ ##change 22 to the right number
...
summary(M14)$coeff[14,1],summary(M14)$coeff[15,1],summary(M14)$coeff[16,1],summary(M14)$coeff[17,1],summary(M14)$coeff[18,1],
...
summary(M14)$coeff[14,2],summary(M14)$coeff[15,2],summary(M14)$coeff[16,2],summary(M14)$coeff[17,2],summary(M14)$coeff[18,2],
...
summary(M14)$coeff[14,4],summary(M14)$coeff[15,4],summary(M14)$coeff[16,4],summary(M14)$coeff[17,4],summary(M14)$coeff[18,4],
M14$null, M14$dev)
#print(fit_results)
#fit_results=as.table(fit.results)
colnames(fit_results)=c("mu","gamma1","gamma1HOM","gamma2","gamma2HOM","gamma3","gamma4","gamma4HOM","gamma5","gamma6","gamma7","gamma8","gamma9","gamma10INT","gamma11INT","gamma12","gamma13","gamma14",
"se1","se1HOM","se2","se2HOM","se3","se4","se4HOM","se5","se6","se7","se8","se9","se10","se11","se12","se13","se14",
"pval1","pval1HOM","pval2","pval2HOM","pval3","pval4","pval4HOM","pvalue5","pvalue6","pvalue7","pvalue8","pvalue9","pvalue10INT","pvalue11INT","pvalue12SNP","pvalue13SNP","pvalue14",
"dev_NULL","dev_M")
}else{
