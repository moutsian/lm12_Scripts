...
source(paste(SCRIPTDIR,"MS_full_model_jun17_SNP.R",sep=""))
...
print(paste("full model analysis - to check SNPs in the DDX39B region for associations. w/o gender, w/o uncertainty, with last term being an interaction with ",INTERACTOR,", with 5 PCs, Printing from ",from," to ",to,", for SNPs in ",COHORT," cohort.",sep=""))

OUTPUTFILE=paste("full_model_june17_SNP.",from,"_",to,".int_with.",INTERACTOR,".",COHORT,sep="")

logreg_14p_nounc_nogender_june17_SNP_INT(casefile,ctrlfile,
