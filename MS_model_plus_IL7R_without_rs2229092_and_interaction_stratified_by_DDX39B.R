...
#alelle="0301"
logreg_14p_nounc_nogender_july17_SNP_WITH_3INT_stratified_by_DDX39B = function(case_file,control_file,
...
cat(i," ");
	...
	DATA[GENO==2,3]=1
	DATA[GENO==0,1]=1
	log_reg_results[i-from+1,]=as.matrix(gwas14_nounc_noG_july17_WITH_3INT_stratified_by_DDX389B(interaction_term,status,COND_DATA,COND_DATA2,COND_DATA3,COND_DATA4,COND_DATA5,COND_DATA6,COND_DATA7,COND_DATA8,COND_DATA9,COND_DATA10,COND_DATA11,CSNPDATA,NONHLACSNPDATA,DATA,PCMATRIX))
	} 
}
cat("\n");

rownames(log_reg_results)= SNP_IDs[from:to]
colnames(log_reg_results)=c("mu","gamma1501","gamma1501HOM","gamma0201","gamma0201HOM","gamma1303","gamma0301","gamma0301REC","gamma0801","gammaB3801","gammaB4402","gammaB5501","gammaDQB0302DOM","gammaDQA0101INT","gammaDQB0301INT","gammars9277565","gammaSNP","gIL7R_INT0","gIL7R_INT1","gIL7R_INT2",
"se1501","se1501HOM","se0201","se0201HOM","se31303","se0301","se0301DOM","se0801","se3801","se4402","se5501","se0302DOM","seDQA0101INT","seDQB0301INT","sers9277565","seSNP","seIL7R_INT0","seIL7R_INT1","seIL7R_INT2",
"pval1501","pval1501HOM","pval0201","pval0201HOM","pval1303","pval0301","pval0301DOM","pvalue0801","pvalue3801","pvalue4402","pvalue5501","pvalue0302DOM","pvalueDQA0101INT","pvalueDQB0301INT","pvaluers9277565","pvalueSNP","pvalIL7R_INT0","pvalIL7R_INT1","pvalIL7R_INT2",
"dev_NULL","dev_M")
