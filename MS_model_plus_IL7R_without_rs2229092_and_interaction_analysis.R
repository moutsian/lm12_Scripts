...
source(paste(SCRIPTDIR,"MS_model_plus_IL7R_without_rs2229092_and_interaction.R",sep="")) 
...
OUTPUTFILE=paste("full_model_july17_3_int_terms_w_IL7R.",from,"_",to,".int_with.",INTERACTOR,".",COHORT,sep="")

logreg_14p_nounc_nogender_july17_SNP_WITH_3INT(casefile,ctrlfile,
