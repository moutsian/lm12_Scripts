...
# Nov 2017 - moving the allelic imbalance cleaning bit to the main variant QC.
...
#PRED3715
#PRED5008 - NS
bsub -q normal -J vcf_filter -G team152 -n4 -R "span[hosts=1] select[mem>2500] rusage[mem=2500]" -M2500 -o ${exomedir}vcffilterpoly_newbcftools.log \
 /software/team152/bcftools/bcftools1.6/bcftools/./bcftools view -S ${exomedir}list_of_samples_to_keep.both.nospecial.txt --force-samples -O v \
 -o ${exomedir}tili.i2.pb.vcf --threads 4 -c1:minor -m2 -M2 -f PASS ${exomedir}v31_ahmad.vcf.gz
...
vcftools --vcf ${exomedir}tili.i2.pb.vcf  --minGQ 30  --recode --recode-INFO-all --out ${exomedir}tili.i2.pb.gq30
...
${bcftoolsdir}./bcftools +setGT --threads 0 -Ov -o ${exomedir}tili.i2.pb.gq30.ab1e03.vcf  \
${exomedir}tili.i2.pb.gq30.recode.vcf --  -n . -t 'b:AD<1e-03'

#filter variants for missingness
vcftools --vcf tili.i2.pb.gq30.ab1e03.vcf --max-missing 0.9 --recode --recode-INFO-all --out tili.i2.pb.gq30.ab1e03.miss10.vcf
...
vcftools --vcf ${exomedir}tili.i2.pb.gq30.ab1e03.miss10.vcf.recode.vcf  --missing-site --out ${exomedir}tili.i2.pb.gq30.ab1e03.miss10.vcf.recode

#replace missing IDs '.' with a name containing the chromosome and position.
${bcftoolsdir}./bcftools annotate --set-id +'%CHROM\_%POS\_%REF\_%FIRST_ALT' ${exomedir}tili.i2.pb.gq30.ab1e03.miss10.vcf.recode.vcf -o ${exomedir}tili.i2.pb.gq30.ab1e03.miss10.rs1.bcf
