...
source(paste(SCRIPTDIR,"MS_full_model_plus_IL7R_no_interaction.R",sep="")) ###here#######
...
COND_SNP2="rs2229092" #13
COND_NONHLA_SNP="Chr5_IL7R_rs6897932" #14
INTERACTOR="DRB1501"
if(INT_TERM==2){
INTERACTOR="A0201"
}else if(INT_TERM==3){
...
print(paste("full model analysis - to check SNPs in the DDX39B region for associations and interaction with IL7R. w/o gender, w/o uncertainty, with last term being an interaction with ",INTERACTOR,", with 5 PCs, Printing from ",from," to ",to,", for SNPs in ",COHORT," cohort.",sep=""))

OUTPUTFILE=paste("full_model_july17_SNP.",from,"_",to,".int_with.",INTERACTOR,".",COHORT,sep="")

logreg_15p_nounc_nogender_july17_SNP_INT(casefile,ctrlfile,
