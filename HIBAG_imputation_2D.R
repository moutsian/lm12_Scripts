...
write.table(pred.guess19_pos$value,paste(basefile,".HLA_A.2D.bestguess.txt",sep=""),sep="\t",col.names=T,row.names=F,quote=F)
write.table(pred.HLAC.guess19_pos$value,paste(basefile,".HLA_C.2D.bestguess.txt",sep=""),sep="\t",col.names=T,row.names=F,quote=F)
write.table(pred.HLAB.guess19_pos$value,paste(basefile,".HLA_B.2D.bestguess.txt",sep=""),sep="\t",col.names=T,row.names=F,quote=F)
write.table(pred.HLADRB1.guess19_pos$value,paste(basefile,".HLA_DRB1.2D.bestguess.txt",sep=""),sep="\t",col.names=T,row.names=F,quote=F)
write.table(pred.HLADQA1.guess19_pos$value,paste(basefile,".HLA_DQA1.2D.bestguess.txt",sep=""),sep="\t",col.names=T,row.names=F,quote=F)
write.table(pred.HLADQB1.guess19_pos$value,paste(basefile,".HLA_DQB1.2D.bestguess.txt",sep=""),sep="\t",col.names=T,row.names=F,quote=F)
write.table(pred.HLADPB1.guess19_pos$value,paste(basefile,".HLA_DPB1.2D.bestguess.txt",sep=""),sep="\t",col.names=T,row.names=F,quote=F)

#now save - all posterior probabilities
write.table(pred.guess19_pos$postprob,paste(basefile,".HLA_A.2D.postprob.txt",sep=""),sep="\t",col.names=T,row.names=T,quote=F)
write.table(pred.HLAC.guess19_pos$postprob,paste(basefile,".HLA_C.2D.postprob.txt",sep=""),sep="\t",col.names=T,row.names=T,quote=F)
write.table(pred.HLAB.guess19_pos$postprob,paste(basefile,".HLA_B.2D.postprob.txt",sep=""),sep="\t",col.names=T,row.names=T,quote=F)
write.table(pred.HLADRB1.guess19_pos$postprob,paste(basefile,".HLA_DRB1.2D.postprob.txt",sep=""),sep="\t",col.names=T,row.names=T,quote=F)
write.table(pred.HLADQA1.guess19_pos$postprob,paste(basefile,".HLA_DQA1.2D.postprob.txt",sep=""),sep="\t",col.names=T,row.names=T,quote=F)
write.table(pred.HLADQB1.guess19_pos$postprob,paste(basefile,".HLA_DQB1.2D.postprob.txt",sep=""),sep="\t",col.names=T,row.names=T,quote=F)
write.table(pred.HLADPB1.guess19_pos$postprob,paste(basefile,".HLA_DPB1.2D.postprob.txt",sep=""),sep="\t",col.names=T,row.names=T,quote=F)
