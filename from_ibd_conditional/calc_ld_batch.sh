...
trait=$1;
chrom=$2;
#lociFile="/lustre/scratch115/teams/anderson/ibd_conditional/tophits_from_our_study/ALL.unique.${chrom}.txt"
...
echo "CHR VARIANT POS AL1 AL2 PVAL LD_LEFT LD_RIGHT" > /lustre/scratch115/teams/anderson/ibd_conditional/results.${trait}.${chrom}.txt
...
echo "${chr} ${name} ${pos} ${al1} ${al2} ${pval} ${min} ${max}">> /lustre/scratch115/teams/anderson/ibd_conditional/results.${trait}.${chrom}.txt
