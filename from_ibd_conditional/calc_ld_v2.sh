...
plink --noweb --vcf tabix.out."${chrom}"."${start}"."${end}".vcf --ld-window-kb 2000 --ld-window 999999 --ld-window-r2 "${rsq}"  --r2 --keep /lustre/scratch115/teams/anderson/ibd_conditional/ceu_gbr.samples.plink  --out plink_ld.out."${chrom}"."${start}"."${end}"
