...
resfile="/lustre/scratch115/teams/anderson/ibd_conditional/final_meta_analysis_C_results/${trait}/results.${trait}.txt"
...
sed -i "s/$original_line/$new_line/" /lustre/scratch115/teams/anderson/ibd_conditional/final_meta_analysis_C_results/${trait}/results.${trait}.txt
