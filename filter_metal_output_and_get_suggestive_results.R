...
colnames(metares_fin)[12:15]=c("Pval_IBDseq","Pval_IIBDGC","Pval_GWAS3","Min_single_cohort_pval")
write.table(metares_fin,paste("/lustre/scratch113/projects/crohns/iibdgc_meta/results/",tolower(trait),"/",chr,"-meta.filtered.LM.txt",sep=""),quote=F,row.names=F,col.names=T,sep="\t")
