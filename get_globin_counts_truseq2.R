...
counts=read.table("/lustre/scratch115/projects/paxgene/SalmonOutput_newruns/IU_sorted.transcript_to_gene.counts",head=T) # this is used for the counts, so library name matters.
