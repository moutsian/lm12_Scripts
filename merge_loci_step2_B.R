...
suggestive=read.table(paste("/lustre/scratch115/teams/anderson/ibd_conditional/UK_only_analysis_B_results/UK_only_analysis_B.",trait,".1e_05.filtered.txt",sep=""),head=T) #change this to contain the filtered version once you have it!
for(chr in 1:22){
