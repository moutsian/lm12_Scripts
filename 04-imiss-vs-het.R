...
inputpathname = args[1] # "/lustre/scratch115/projects/crohns/exome/TIH/TIM_controls_BIRDSUITE.corrected"
outputpathname = paste(inputpathname,".pdf",sep="")
hetlinesd = as.numeric(args[2])
...
abline(v=log10(missingnessline2), col="RED", lty=2)
dev.off()
